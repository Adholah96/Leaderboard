...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _modules_postdata__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../modules/postdata */ \"./modules/postdata.js\");\n/* harmony import */ var _modules_fetchdata__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../modules/fetchdata */ \"./modules/fetchdata.js\");\n/* harmony import */ var _modules_displayData__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../modules/displayData */ \"./modules/displayData.js\");\n\n\n\n\n\nconst refreshBtn = document.querySelector('.refreshbtn')\nconst form = document.querySelector('.form')\nconst nameInput = form.elements.name\nconst scoreInput = form.elements.score\n\nrefreshBtn.addEventListener('click', async () => {\n  console.log('clicked')\n  ;(0,_modules_displayData__WEBPACK_IMPORTED_MODULE_3__[\"default\"])(await (0,_modules_fetchdata__WEBPACK_IMPORTED_MODULE_2__[\"default\"])())\n})\n\nconst addScore = async (e) => {\n  e.preventDefault()\n\n  const result = await (0,_modules_postdata__WEBPACK_IMPORTED_MODULE_1__[\"default\"])(nameInput.value, scoreInput.value)\n\n  if (result) {\n    nameInput.value = ''\n    scoreInput.value = ''\n\n    ;(0,_modules_displayData__WEBPACK_IMPORTED_MODULE_3__[\"default\"])(await (0,_modules_fetchdata__WEBPACK_IMPORTED_MODULE_2__[\"default\"])())\n  }\n}\nconst init = async () => {\n  const data = await (0,_modules_fetchdata__WEBPACK_IMPORTED_MODULE_2__[\"default\"])()\n  if (data) {\n    (0,_modules_displayData__WEBPACK_IMPORTED_MODULE_3__[\"default\"])(data)\n  }\n\n  if (form) {\n    form.addEventListener('submit', addScore)\n    nameInput.value = ''\n    scoreInput.value = ''\n  }\n\n  if (refreshBtn) {\n    refreshBtn.addEventListener('click', async () => {\n      console.log('refresh button clicked')\n      const data = await (0,_modules_fetchdata__WEBPACK_IMPORTED_MODULE_2__[\"default\"])()\n      if (data) {\n        (0,_modules_displayData__WEBPACK_IMPORTED_MODULE_3__[\"default\"])(data)\n      }\n    })\n  }\n}\n\ninit()\n\n\n//# sourceURL=webpack://leaderboard/./src/index.js?");
